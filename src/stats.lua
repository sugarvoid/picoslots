stats_panel = {
    ...
    draw = function(self)
        ...
        if self.is_active then
            rectfill(-60, 0, 0, 50, 0)
            print("\014 debt   " .. pad_zeros(player_stats.debt, 5), self.x, 7, 8)
            print("\014 earned " .. pad_zeros(player_stats.earned, 5), self.x, 21, 7)
            print("\014 pulls  " .. pad_zeros(player_stats.total_pulls, 5), self.x, 28, 7)
            print("\014 2-kind " .. pad_zeros(player_stats.two_kind, 5), self.x, 35, 7)
