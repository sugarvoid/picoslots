stats_panel = {
    ...
    draw = function(self)
        ...
        print("\014 pulls:  " .. pad_zeros(player_stats.total_profit, 5), self.x, 21, 7)
        print("\014 2-kind: " .. pad_zeros(player_stats.total_pulls, 5), self.x, 28, 7)
        print("\014 3-kind: " .. pad_zeros(player_stats.two_kind, 5), self.x, 35, 7)
